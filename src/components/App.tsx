  ...
  <Provider store={store}>
    <Router>
      <Switch>
        ...
        <PrivateRouter exact path="/taxes" component={Taxes} />
        <PrivateRouter path="/taxes/:id/form" component={FormSub} />
        <PrivateRouter path="/submissions" component={AllSubmissions} />
        <PrivateRouter path="/taxes/:id/submissions" component={Submissions} />
